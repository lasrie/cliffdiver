...
class _AddressSearchState extends State<AddressSearch> {
  ...
  void setPlacesState(Future<List<MapBoxPlace>?> places)
  {
    // still too deep in my opinion. Nested loops should be avoided when possible
  ...
  Widget build(BuildContext context) {
    // this was way to deep. Seperate into smaller steps
